Use Olympics;
-- Sample table structure for `summer_olympics`
CREATE TABLE OlympicResults (
    Year INT,
    City VARCHAR(100),
    Sport VARCHAR(100),
...
INSERT INTO OlympicResults (Year, City, Sport, Discipline, Athlete, Country, Gender, Event, Medal)
VALUES
...
(1896, 'Athens', 'Cycling', 'Cycling Track', 'FLAMENG, Léon', 'FRA', 'Men', 'Sprint Individual', 'Bronze'),
(1896, 'Athens', 'Cycling', 'Cycling Track', 'MASSON, Paul', 'FRA', 'Men', 'Sprint Individual', 'Gold'),
(1896, 'Athens', 'Cycling', 'Cycling Track', 'NIKOLOPOULOS, Stamatios', 'GRE', 'Men', 'Sprint Individual', 'Silver'),
